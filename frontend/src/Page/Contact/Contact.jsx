  ...
  return (
    <div className="min-h-screen bg-white py-32">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-l6">
          ...
          <div>
            <form className="bg-white rounded-2xl shadow-xl p-8">
              <div className="space-y-6">
                ...
                <button className="w-full bg-blue-600 text-white py-4 rounded-lg font-medium hober:bg-blue-700 transition-colors duration-300">
                  문의하기
                </button>
              </div>
            </form>
